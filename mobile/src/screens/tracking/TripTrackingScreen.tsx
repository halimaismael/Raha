...
export default function TripTrackingScreen({ route }: any) {
  ...
  // booking.agency est absent pour un véhicule de chauffeur indépendant — on
  // retombe alors sur le nom/téléphone du chauffeur (indépendant ou
  // d'agence) assigné à la course. Accéder directement à booking.agency.name
  // ferait planter l'écran (page blanche) dès qu'il n'y a pas d'agence.
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topCard}>
        ...
        <Text style={typography.h2}>{ownerName}</Text>
