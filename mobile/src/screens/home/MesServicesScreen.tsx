...
export default function MesServicesScreen({ navigation }: any) {
  function openServiceCard(service: typeof SERVICES[number]) {
    ...
    } else if (service.key === 'COURSES') {
      navigation.navigate('CoursesIntro', { purpose: service.purpose, title: service.title });
    } else if (service.key === 'LOCATION') {
      navigation.navigate('RentalIntro');
    } else if (service.key === 'MWANA') {
      navigation.navigate('MwanaForm', { purpose: service.purpose, title: service.title });
    } else if (service.type === 'VOITURE') {
      navigation.navigate('ChooseProvider', { purpose: service.purpose, title: service.title });
    } else {
