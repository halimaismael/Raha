...
export default function MwanaAppointmentScreen({ route, navigation }: any) {
  const { title, duration, durationLabel, numberOfPeople, tripsPerDay, city } = route.params || {};
    ...
    return (
      <ScrollView style={styles.container} contentContainerStyle={{ padding: 24, paddingTop: 60, paddingBottom: 60 }}>
        ...
        <Text style={styles.successText}>
          ...
          en agence au créneau choisi pour finaliser votre dossier.
        </Text>
        ...
        <View style={styles.reminderCard}>
          ...
          <Text style={styles.reminderItem}>• Un justificatif d'identité de l'enfant (extrait de naissance ou carte scolaire)</Text>
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24, paddingTop: 60, paddingBottom: 60 }}>
      ...
      <Text style={styles.intro}>
        Le service {title || 'Raha Mwana'} nécessite une inscription en personne. Prenez rendez-vous avec
        une agence Raha : vous devrez vous présenter avec des justificatifs d'identité pour finaliser
        votre dossier.
      </Text>
