...
export default function BookingScreen({ route, navigation }: any) {
  const {
    vehicle, trip, initialPurpose, initialScheduledDateISO, initialPickupName, initialDropoffName,
  }: {
    vehicle: Vehicle; trip?: Trip; initialPurpose?: string; initialScheduledDateISO?: string;
    initialPickupName?: string; initialDropoffName?: string;
  } = route.params;
  ...
  const [pickupName, setPickupName] = useState(initialPickupName || '');
  const [dropoffName, setDropoffName] = useState(initialDropoffName || '');
