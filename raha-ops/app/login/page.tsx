    ...
    <div className="min-h-screen flex bg-sand">
      <div className="hidden lg:flex w-1/2 bg-ocean relative overflow-hidden flex-col justify-between p-14">
        <div className="flex items-center gap-3 relative z-10">
          ...
          <div className="text-sand text-xl font-display font-bold tracking-tight">Agence Raha</div>
        </div>

        <div className="relative z-10">
          <p className="text-ylang font-display italic text-lg mb-3">Espace interne — équipe Raha</p>
          <h1 className="text-sand text-4xl font-display font-bold leading-tight max-w-md">
            Toute la plateforme, sous contrôle.
          </h1>
          <p className="text-sand/70 mt-4 max-w-sm">
            Chauffeurs indépendants, agences, usagers et rendez-vous Raha Mwana — validez et
            supervisez tout depuis un seul endroit, réservé à l'équipe Raha.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          <div className="flex lg:hidden items-center gap-2.5 mb-8">
            ...
            <div>
              <div className="text-base font-display font-bold text-charcoal leading-tight">Agence Raha</div>
              <div className="text-[11px] text-coral italic leading-tight">Espace interne — équipe Raha</div>
            </div>
          </div>

          <h2 className="text-2xl font-bold text-charcoal mb-1 font-display">Connexion équipe Raha</h2>
          <p className="text-slate mb-6 text-sm">Réservé aux administrateurs de la plateforme Raha.</p>
